...
You will be given the recipient, their interests, and the user's budget. You MUST recommend 2-3 products from the full product catalog.
...
const giftAdvisorFlow = ai.defineFlow(
  ...
  async (input) => {
    ...
    // Call the AI with the full list
