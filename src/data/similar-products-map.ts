...
export const similarProductsMap: Record<string, string[]> = {
  'product-1': ['product-2', 'product-15', 'product-7', 'product-118'], // Lantern -> Other solar/camping lights
  ...
  'product-4': ['product-27', 'product-36', 'product-62', 'product-12'], // Gaming Console -> Other gaming/tablets
  'product-5': ['product-8', 'product-43', 'product-50', 'product-15'], // Solar power bank -> Other power banks
  'product-6': ['product-11', 'product-44', 'product-5', 'product-8'], // Hard drive -> Other storage/adapters
  ...
  'product-12': ['product-21', 'product-24', 'product-25', 'product-4'], // Tablet with keyboard -> Other tablets
  ...
  'product-20': ['product-22', 'product-26', 'product-34', 'product-49'], // Smart watch -> Other smart watches
  'product-21': ['product-12', 'product-24', 'product-25', 'product-4'], // A20 Tablet -> Other tablets
  'product-22': ['product-20', 'product-26', 'product-34', 'product-49'], // Ultra Smart Watch -> Other smart watches
  ...
  'product-26': ['product-20', 'product-22', 'product-34', 'product-49'], // Ultra T8 watch -> Other smart watches
  'product-27': ['product-4', 'product-36', 'product-62', 'product-72'], // 4K Gaming Console -> Other gaming
  'product-28': ['product-3', 'product-36', 'product-4', 'product-27'], // Portable Cinema -> Other media devices
  'product-30': ['product-14', 'product-8', 'product-43', 'product-5'], // iPhone 13 case -> iPhone 15 case, power banks
  'product-31': ['product-41', 'product-33', 'product-7', 'product-15'], // Mini charging station -> Other solar/power
  'product-32': ['product-39', 'product-9', 'product-60', 'product-61'], // Bulb camera -> Other cameras
  'product-33': ['product-41', 'product-31', 'product-7', 'product-15'], // Solar power kit -> Other solar/power
  'product-34': ['product-20', 'product-22', 'product-26', 'product-49'], // Smart ring -> Other smart watches/health
  ...
  'product-39': ['product-32', 'product-9', 'product-60', 'product-61'], // Mini security camera -> Other cameras
  ...
  'product-57': ['product-101', 'product-115', 'product-47', 'product-54'], // Camping chair/bed -> Other chairs
  ...
  'product-69': ['product-140', 'product-75', 'product-94', 'product-81'], // Glass defogger -> Other car care
  ...
  'product-101': ['product-57', 'product-115', 'product-47', 'product-54'], // Folding chair w/ table -> Other chairs
  'product-102': ['product-83', 'product-79', 'product-77', 'product-82'], // Exercise wheel -> Other fitness
  'product-103': ['product-76', 'product-63', 'product-95', 'product-58'], // Super glue -> Other tools
  'product-104': ['product-34', 'product-49', 'product-20', 'product-22'], // Tasbeeh ring -> Other wearables/gadgets
  ...
  'product-108': ['product-110', 'product-140', 'product-123', 'product-113'], // Clothes/shoe washer -> Other home appliances
  ...
  'product-116': ['product-113', 'product-123', 'product-148', 'product-155'], // Toaster -> Other kitchen appliances
  ...
  'product-137': ['product-108', 'product-110', 'product-140', 'product-147'], // Lint remover -> Other home care
  ...
  'product-140': ['product-112', 'product-150', 'product-117', 'product-147'], // Movable base -> Other home/storage
  ...
  'product-147': ['product-112', 'product-150', 'product-117', 'product-140'], // Wall-mounted rack -> Other storage
