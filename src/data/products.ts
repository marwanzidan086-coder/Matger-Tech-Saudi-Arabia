...
- الضمان: عامين`,
      ...
      category: categories.electronics.slug,
      warranty: 'عامين',
      story: "عندما انقطعت الكهرباء في ليلة عاصفة، لم يشعر 'خالد' بالقلق. أخرج كشاف DLC وثبته مغناطيسيًا على الثلاجة، فأضاء المطبخ بالكامل، وشحن هاتفه في نفس الوقت. كان أكثر من مجرد كشاف، كان شعلة أمان في الظلام.",
      faq: [
