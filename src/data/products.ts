...
- الألوان: فحمي, طباشيري`,
        ...
        category: categories.electronics.slug,
        warranty: 'عام واحد',
        story: "بينما كانت 'نوف' تعد العشاء، قالت: 'يا جوجل، أرني وصفة اللازانيا على يوتيوب'. ظهر الفيديو على شاشة Nest Hub. لم تكن مجرد شاشة، بل كانت مساعد الشيف الخاص بها 🧑‍🍳.",
        faq: [
...
- عمر البطارية: يصل إلى 6 أشهر`,
        ...
        category: categories.home.slug,
        warranty: 'عام واحد',
        story: "كان 'الأطفال' يتركون دائمًا صنبور الماء مفتوحًا. بعد تركيب المحول الذكي، أصبح الماء يتدفق فقط عند الحاجة. لم يكن مجرد جهاز، بل كان معلمًا صغيرًا يعلمهم قيمة الحفاظ على الماء 💧.",
        faq: [
...
- مقاوم للماء: IPX5`,
        ...
        category: categories.home.slug,
        story: "كانت نبتة 'حنان' تبدو ذابلة. وضعت المستشعر الذكي في التربة، فأخبرها التطبيق أنها تحتاج إلى المزيد من الضوء. نقلتها إلى نافذة مشمسة، فعادت إليها الحياة. كان المستشعر هو الطبيب الذي يشخص حالة نباتاتها 👨‍⚕️🌿.",
        faq: [
...
- المادة: معدن`,
        ...
        category: categories.home.slug,
        warranty: 'عام واحد',
        story: "كانت اللوحة التي رسمها 'والد فهد' معلقة في الظلام. بعد تركيب الإضاءة الذكية، أصبحت اللوحة هي محور الغرفة، تبرز تفاصيلها وألوانها. كانت الإضاءة هي التي أعطت الفن حقه من الاهتمام 💡🎨.",
        faq: [
...
- المحتويات: باب، طوق ذكي واحد`,
        ...
        category: categories.home.slug,
        warranty: 'عام واحد',
        story: "كانت قطة الجيران تدخل دائمًا وتأكل طعام قطة 'أميرة'. بعد تركيب الباب الذكي، أصبح يفتح فقط لقطتها. كان حارسًا شخصيًا يحمي مملكة قطتها وطعامها 👑.",
        faq: [
...
- سهل التنظيف`,
        ...
        category: categories.home.slug,
        warranty: 'عام واحد',
        story: "كانت كنزة 'مريم' الصوفية المفضلة مليئة بالوبر. استخدمت مزيل الوبر الذكي، وفي دقائق، عادت الكنزة لتبدو جديدة تمامًا. كان جهازها هو طبيب تجميل ملابسها 👕✨.",
        faq: [
...
- المادة: فولاذ مقاوم للصدأ`,
        ...
        category: categories.home.slug,
        warranty: 'عامان',
        story: "كل صباح، كان 'خالد' يستمتع برائحة حبوب القهوة وهي تطحن في مطحنته الذكية. كانت هذه هي بداية يومه المثالية. كانت المطحنة هي التي تصنع له فنجان السعادة الأول ☕.",
        faq: [
...
- التغطية: تصل إلى 40 مترًا مربعًا`,
        ...
        category: categories.home.slug,
        warranty: 'عام واحد',
        story: "في ليالي الشتاء الجافة، كان المرطب الذكي يعمل بصمت في غرفة نوم 'عائلة آل سالم'، محافظًا على رطوبة الهواء ومساعدتهم على التنفس بشكل أفضل. كان حارس نومهم الهادئ 🌙.",
        faq: [
...
- مصدر الطاقة: كهربائي`,
        ...
        category: categories.home.slug,
        warranty: 'عام واحد',
        story: "كل مساء، كانت 'ليلى' تقرأ كتابها تحت الضوء الدافئ للمصباح الذكي، الذي يحاكي غروب الشمس ويساعدها على الاسترخاء. كان رفيقها الذي يهيئها لأحلام سعيدة 📖.",
        faq: [
