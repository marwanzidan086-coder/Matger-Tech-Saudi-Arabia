...
const product: Product = {
  ...
  story: 'وداعًا لدموع تقطيع البصل! هذه الفرامة هي يدك اليمنى في المطبخ. بسرعتيها وشفراتها الحادة، تفرم اللحوم والخضروات في ثوانٍ، لتحول مهمة الطبخ الشاقة إلى متعة وسرعة.',
