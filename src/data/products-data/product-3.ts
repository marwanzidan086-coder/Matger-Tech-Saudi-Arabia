...
const product: Product = {
  ...
  story: `في عالم مليء بالشاشات المعقدة، تأتي شاشة "الفارس" لتعيد البساطة إلى مجدها. ليست مجرد شاشة، بل هي نافذة تفتح لك على عالم من الألوان الواضحة والصوت النقي. صُممت لتكون قلب غرفة المعيشة، حيث تجتمع العائلة لمشاهدة فيلم، متابعة مباراة، أو حتى توصيل أجهزتهم بسهولة عبر HDMI و USB. إنها البساطة التي تصنع السعادة.`,
