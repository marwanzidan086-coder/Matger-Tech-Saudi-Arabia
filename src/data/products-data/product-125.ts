...
const product: Product = {
  ...
  story: 'استلقِ، استرخِ، واستمع. هذا الكرسي القابل للنفخ ليس مجرد مكان للجلوس، بل هو تجربة متكاملة. بمكبر الصوت المدمج، يمكنك أن تستمتع بموسيقاك المفضلة وأنت تسترخي. إنه الحل الأمثل للجمع بين الراحة والترفيه.',
