...
const product: Product = {
  ...
  description: `يقوم بالشحن عن طريق الطاقة الشمسية والاستغناء عن الكهرباء. مناسب للحدائق ومقدمات المنازل. يعمل إذا حدثت أي حركة بالقرب منه ثم ينطفيء ذاتيا لتوفير الشحن.
###FEATURES###
- بطارية قوية توفر إضاءة مستمرة وموزعة بانتظام طوال الليل.
- سهل التركيب.
- 3 أوضاع إضاءة: ضوء طويل خافت, مستشعر ضوء قوي, مستشعر حركة.
###DETAILS###
- البطارية: 1200mAh.
