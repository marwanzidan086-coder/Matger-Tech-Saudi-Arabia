...
const product: Product = {
  ...
  description: `سعة 500GB فعلية (465GB). واجهة USB 3.0 عالية السرعة. تصميم معدني أنيق ومتين. مقاوم للصدمات والخدوش. تشغيل مباشر بدون برامج.###DETAILS###- الحجم: 2.5 إنش
- السرعة: 5400 RPM
- الواجهة: USB 3.0
- المادة: معدن`,
  price: 90,
