...
const product: Product = {
  ...
  story: `كانت "سارة" طالبة جامعية تحلم بجهاز يجمع بين خفة التابلت وقوة اللابتوب. مع تابلت 07، تحقق حلمها. أصبح بإمكانها كتابة محاضراتها بالكيبورد المرفق، والرسم بالقلم الذكي، ثم فصلهما للاستمتاع بمشاهدة فيلم في المساء. لم يعد جهازًا، بل أصبح شريكها في الدراسة والإبداع والترفيه.`,
