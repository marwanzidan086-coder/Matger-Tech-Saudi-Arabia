...
const product: Product = {
  ...
  description: `إضاءة قوية بفضل لمبات LED 5730 الموفرة. يشتغل بالطاقة الشمسية بدون كهرباء أو أسلاك. بطارية 25000mAh تدوم حتى 16 ساعة. يدعم التحكم بالريموت عن بعد بكل سهولة. فيه حساس رادار يشتغل أوتوماتيكي مع الحركة. مقاوم للمطر والغبار بمعيار حماية IP67.###DETAILS###- الماركة: دينيكس
