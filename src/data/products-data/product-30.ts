...
const product: Product = {
  ...
  story: `لكل هاتف أسطوري، درع يستحقه. هذا الكفر لجهاز آيفون 13 برو ماكس ليس مجرد حماية، بل هو شريان حياة إضافي. صُمم ليحتضن هاتفك بأناقة، ويمنحه القوة لمواجهة يوم طويل دون خوف من نفاد البطارية أو خطر السقوط. إنه وعد بالاستمرارية والأمان لهاتفك الثمين.`,
