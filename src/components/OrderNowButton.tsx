...
export function OrderNowButton({ product }: { product: Product }) {
  ...
  return (
    <Button 
      ...
      size="lg" 
      className="w-full text-lg font-bold bg-blue-600 text-white shadow-lg shadow-blue-500/50 transition-all duration-300 hover:scale-105 hover:bg-blue-700 hover:shadow-blue-500/80"
    >
